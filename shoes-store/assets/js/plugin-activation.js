jQuery(document).ready(function($) {
    'use strict';
    var this_obj = shoes_store_plugin_activate_plugin;

    $(document).on('click', '.shoes-store-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message shoes-store-plugin-install');
                button.addClass('button-primary shoes-store-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.shoes-store-recommended-plugins .shoes-store-activation-note').css('display','block');
    ...
    $(document).on('click', '.shoes-store-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .shoes-store-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .shoes-store-recommended-plugins').css('display','none');
    });
